...
", "aalborg", "universitet", "�???o", "proufbt", "ufbrm", "eufbect", "diufber", "ufbrst", "deufbn", "speciufbc", "signiufbc", "ufbnd", "�???", "firm�???T", "�???o", "vol", "thern", "ofrn", "journal", "tion", "andrn", "octob" )
...
# Use the custom function for processing
documents <- lapply(files, process_pdf_and_log)

# Filter out NULLs returned for ignored files
